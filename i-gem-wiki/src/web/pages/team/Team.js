      ...
      <CustomScrollbar>
        ...
        <div className="main-content">
          <div className= "page-text green">
            ...
            <p><b>In   Germany,   there   is   the   acronym   -   “TEAM:   Toll   Ein   Anderer
            macht's which means "great, there is another person who can do this
            stuff, so, I don' t care." </b></p> 
            <p>Finding team members and bringing them together as a team was
            one of the first milestones in our iGEM project. In the beginning, we were
            several students 
            of which 
            most don' t know each other and we would be
            working together for several months. Within the months we weren' t just
            students with the same passion: 
            TherMal.UP.
             We also became friends and
            created a great working spirit which led to helping hands whenever you
            face a problem.</p>
            <p>If you want to know some more about our
             20 
            student members from
            different study backgrounds  
            such as Bioscience, Computer Science and
            Informatics as well as about our team building activities, you will 
            find some
            pictures and information e.g. a quote from everyone on the next page.
            </p>
            <p>
            We also got great support from our supervisors as Prof. Dr. Chiantia,
            the work group of Prof. Dr. Wendler and the work group from Dr. Bidan.
            </p>
          </div>
          <TeamGrid/>
        </div>
