...
One of the team members (Aaron Spieler) did his bachelors based on the work he did for the insilico team. His thesis is mainly concerned with the *BacDive+* and *Merck&Co+* datasets. You can find the theses itself [here](bachelor_thesis_spieler.pdf). 
